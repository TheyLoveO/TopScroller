...
func (g *Game) initImages() {
	...
	// sprites are optional; if missing we draw rectangles
...
func (g *Game) Update() error {
	// IMPORTANT: per your request, there is NO restart here.
...
/* ---------------- program entry ---------------- */
func main() {
	ebiten.SetWindowTitle("Top Scroller — no restart")
